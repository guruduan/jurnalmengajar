...
$filename = $bulan && $tahun ? "jurnal_{$namabulan}_{$tahun}.ods" : "jurnal_mengajar_semua.ods";
...
$sheet->mergeCells('A2:I2')->setCellValue('A2', 'SMAN 2 KANDANGAN');
$sheet->mergeCells('A3:I3')->setCellValue('A3', 'TAHUN AJARAN 2025/2026');
...
// Header tabel
$sheet->fromArray(['No', 'Hari Tanggal', 'Kelas', 'Jam Ke', 'Mata Pelajaran', 'Materi', 'Aktivitas KBM', 'Absen', 'Keterangan'], NULL, 'A8');
...
$sheet->setCellValue("H{$row}", 'Hulu Sungai Selatan, ' . date('d M Y'));
$row++;
